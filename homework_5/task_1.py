...
def ent_profit():
    ...
    for i in range(ent_count):
        ent_name = input(f'Введите название {i + 1} организации: ')
        ent_dict[ent_name] = enterprises(
            ent_name=ent_name,
            profit_1=int(input(f'Введите прибыль {ent_name} в 1 квартале: ')),
            profit_2=int(input(f'Введите прибыль {ent_name} во 2 квартале: ')),
            profit_3=int(input(f'Введите прибыль {ent_name} в 3 квартале: ')),
            profit_4=int(input(f'Введите прибыль {ent_name} в 4 квартале: ')))
    average_profit = 0
