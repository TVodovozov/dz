...
def encoding_haffman(value):
    heap = [(i, v) for v, i in Counter(value).items()]
    heapify(heap)
    print(heap)
    ...
    return ''.join([h[i] for i in value]), d_h


st, dct = encoding_haffman(input('Введите число или строку: '))
